...
<nav className="relative px-4 py-4 flex justify-between items-center bg-white">
		...
		<Link to="/login" className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200" >Log In</Link>
	...
	<div className="navbar-menu relative z-50 hidden">
		...
		<nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
			...
			<div className="mt-auto">
				<div className="pt-6">
					<Link to="/signup" className="block px-4 py-3 mb-3  text-xs text-center font-semibold bg-gray-50 hover:bg-gray-100 rounded-xl" >Log in</Link>
					<Link to="/login" className="block px-4 py-3 mb-2 leading-loose text-xs text-center text-white font-semibold bg-blue-600 hover:bg-blue-700  rounded-xl" >Sign Up</Link>
				</div>
